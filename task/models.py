...
class Tool(models.Model):
    ...
    INPUT_TYPE_PARA = 'para'
    input_type_choices = ((INPUT_TYPE_FILE, '文件'), (INPUT_TYPE_PARA, '参数'))
    ...
    input_type = models.CharField(verbose_name='输入参数类型', choices=input_type_choices, max_length=10)
